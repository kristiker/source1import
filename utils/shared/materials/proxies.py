...
def ProxiesToDynamicParams(vmtProxies: VDFDict, known, KeyValues) -> DynamicParams:
    ...
    for proxy, proxyParams in vmtProxies.items():
        ...
        vmatDynamicParams[dpKey] = repr(dynEx) # "clamp(random(1), 0.4, 0.6)"
